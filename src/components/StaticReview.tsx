...
export default function staticReview(props: { src: string | undefined }) {
  return (
    <>
      <div className="flex justify-evenly ml-80 gap-40  md:flex md:justify-evenly md:gap-20  md:mt-[-16em] xs:flex xs:justify-evenly  xs:ml-60 xs:gap-20 xs:w-[50em] xs:mt-[-10em]">
        <div className="w-60 h-60 rounded border border-gray-300 ml-80  md:ml-16 ">
          <img
