...
function HeaderNav() {
  return (
    <div className="flex gap-5 sm:sticky top-0 z-40"> 
        <div className=" sticky top-0 gap-7 bg-white pt-3 pb-3 pr-3 flex flex-row flex-wrap  mb-3 md:justify-end  lg:justify-end  justify-center w-[100%]">
            <div className='flex justify-end md:justify-end gap-10 items-center '>
                ...
                <div className="dashboard__search  border rounded-md flex gap-3 p-1">
