...
import { ToastNotificationAction,DisplayNotificationAction } from '../action/NotificationAction';
...
const NotificationSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(ToastNotificationAction.fulfilled, (state, action: PayloadAction<any>) => {
        state.loading = false;
    ...
    .addCase(DisplayNotificationAction.pending, (state) => {
      ...
      .addCase(DisplayNotificationAction.fulfilled, (state, action: PayloadAction<any>) => {
        state.loading = false;
        state.status = 'notification Request Successfully!';
        state.data = action.payload;
        state.error = null;
