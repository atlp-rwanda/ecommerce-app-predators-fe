...
export default function staticReview(props: { src: string | undefined }) {
  ...
  return (
    <>
      <div className="flex justify-evenly w-screen  md:gap-20  md:mt-[-16em] xs:ml-20 xs:gap-20 xs:w-[50em] xs:mt-[-10em]">
        <div className='flex justify-center grid-cols-4 gap-10 ml-[8em]'>
            ...
            <div className="py-6 ">
              ...
              {showForm ? (
                <div className="pop-up-form">
                  <Review onClose={toggleForm} />
                </div>
              ) : (
                <button
                  className="text-white border border-gray-500 rounded-md px-6 py-1 mt-5 bg-primary"
                  onClick={toggleForm}
                >
                  Reviews
                </button>
