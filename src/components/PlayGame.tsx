...
const PlayGame = () => {
  return (
    <div className='absolute left-[60em] mt-8 '>
        <h1 className='font-medium text-blue-500'>Play Game</h1>
...
<p className='flex'>Availability: <FaCheck className="text-green-500 ml-2" size={24} /> <span className='text-green-500'>In stock</span></p>
<hr className='gap-10'/>
    </div>
  )
}
