  ...
  return (
    <div className=" font-Poppins">
      <div className=" max-[768px]:hidden py-5 px-[7%] flex justify-between relative">
        <div>
          <span className="text-sm">Need help? Call us: (+25) 0785 7676 47</span>
        </div>
        ...
        <div className="flex justify-between px-[7%] pt-7 pb-5 md:pb-7 items-center">
          <div className="flex gap-10 grow-[5] justify-between">
            ...
            <div className="flex max-[768px]:hidden grow max-w-[1000px] text-sm relative">
              <input type="text" className=" rounded-3xl p-2 w-full pr-[85px]" placeholder="Search anything"/>
              <button type="button" className=" bg-tertiary text-white rounded-3xl px-5 absolute h-full right-0 text-center">Search</button>
            </div>
          </div>
      ...
      <div className={`sideMenu ${ isOpen ? "translate-x-0" : "-translate-x-96" } transition-transform ease-in-out duration-500 fixed top-0 h-screen z-10 w-96`}>
        <div className="flex flex-col gap-10 bg-customBlue h-full pt-10 pl-10 pr-5">
          <div className="cursor-pointer flex items-center justify-between">
            <img src={logo} alt=""/>
            <div className="flex items-center gap-3 cursor-pointer text-white hover:text-tertiary" onClick={handleMenu}>
          ...
          <ul className=" text-white font-Poppins flex gap-5 flex-col">
            ...
            <li>
              <Link to={"/"} className=" hover:text-tertiary">About us</Link>
            </li>
          </ul>
        </div>
      </div>
